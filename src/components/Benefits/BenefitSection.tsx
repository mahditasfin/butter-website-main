...
const BenefitSection: React.FC<Props> = ({ benefit, imageAtRight }: Props) => {
    ...
    return (
        <section className="benefit-section">
            <motion.div
                className="flex flex-wrap flex-col items-center justify-center gap-6 lg:flex-row lg:gap-32 lg:flex-nowrap mb-24"
            ...
            >
                ...
                <div className={clsx("mt-5 lg:mt-0", { "lg:order-2": imageAtRight })}>
                    <div className={clsx("w-fit flex border-4 border-[#6E6E6E] rounded-[2.3rem]", { "justify-start": imageAtRight, "justify-end": !imageAtRight })}>
                        <Image 
                            src={imageSrc} 
                            alt="title" 
                            width="350" 
                            height="762" 
                            quality={100} 
                            className="lg:ml-0 rounded-[2rem]"
                        />
                    </div>
                </div>
            </motion.div>
